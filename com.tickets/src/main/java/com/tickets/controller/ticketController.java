...
public class ticketController  {
    ...
    public String login(@RequestParam String email, @RequestParam String password) {
        try {
            ...
            if (user != null) {
                System.out.println(user.getEmail() + "----------- output-----------------");
                System.out.println(user.getRole() + "----------- output-----------------");
                System.out.println(user.getPhonenumber() + "----------- output-----------------");
                System.out.println(user.getEnabled() + "----------- output-----------------");
